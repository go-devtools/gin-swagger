...
See the core's [request and response declaration reference](https://github.com/go-devtools/openapi/blob/fb93d0a624f7945a0509243c5ed99fea1fbf34ea/docs/request-response-declarations.md) for exact syntax, scoped type expressions, codec reuse, conservative conflict checks, and structured diagnostics.
